...
namespace ProgrammersBlog.Mvc.Helpers.Concrete
{
    public class ImageHelper : IImageHelper
    {
        ...
        {
            _env = env;
            _wwwroot = _env.WebRootPath;    // Bu işlem dinamik olarak string şekilde wwwroot klasörümüzün dosya yolunu tutucak.Bu sınıftaki tüm metotlardan erişebilelim diye buraya koyduk.
        }
        ...
        public IDataResult<ImageDeletedDto> Delete(string pictureName)
        {
            ...
            if (System.IO.File.Exists(fileToDelete))    // Böyle bir dosya yolu var mı diye kontrol ediyoruz.
            {
                var fileInfo = new FileInfo(fileToDelete);  // Bu dosyayı silmeden önce dosyayla ilgili belirli bilgileri imageDeletedDto içersinde saklıyoruz.
                ...
                System.IO.File.Delete(fileToDelete);        // Resmimizi siliyoruz.
                return new DataResult<ImageDeletedDto>(ResultStatus.Success, imageDeletedDto);
            }
            else   // Böyle bir dosya yolu bulamazsa.
            {
