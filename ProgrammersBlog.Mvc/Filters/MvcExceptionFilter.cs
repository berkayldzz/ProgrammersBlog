...
namespace ProgrammersBlog.Mvc.Filters
{
    public class MvcExceptionFilter:IExceptionFilter
    {
        ...
        // OnException içersine girdiysek uygulamamızda bir hata fırlatıldı demektir.
        public void OnException(ExceptionContext context)
        {
            if (_environment.IsDevelopment())
            {
                context.ExceptionHandled = true;            // Hata kısmının ele alındığını ve bununla ilgili işlem yapıldığını belirtiyoruz.
