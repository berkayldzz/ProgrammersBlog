...
namespace ProgrammersBlog.Mvc.Areas.Admin.Controllers
{
    ...
    public class OptionsController : Controller
    {
        ...
        private readonly IWritableOptions<AboutUsPageInfo> _aboutUsPageInfoWriter;   // AboutUsPageInfo modelini güncellemek istiyoruz.
        ...
        {
            return View(_aboutUsPageInfo);    // Formun dolu gelmesi gerekiyor ki güncelleyebilelim.
        }
        [HttpPost]
        public IActionResult About(AboutUsPageInfo aboutUsPageInfo)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // Modelimizden gelen verilerin appsettings.json üzerine yazılmasını sağlıyoruz.
        ...
        [HttpGet]
        public IActionResult GeneralSettings()  // WebsiteInfo sınıfımızın güncellenmesini sağlayacak.
        {
