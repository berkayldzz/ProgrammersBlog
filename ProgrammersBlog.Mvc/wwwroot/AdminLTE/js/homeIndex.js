$(document).ready(function () {
    ...
    $.get('/Admin/Article/GetAllByViewCount/?isAscending=false&takeSize=10',  // Makale listemizi aldık(belirli filtrelerle)
        function (data) {
            const articleResult = jQuery.parseJSON(data);  // articleResult adlı obje içersinde $values adlı makaleler arrayi var.
