...
namespace ProgrammersBlog.Services.Abstract
{
    ...
    {
        // Bu interfacemizde Servis katmanımızda Article sınıfımız ile ilgili kullanmak istediğimiz metot ve işlemlerimizin imzalarını barındırıyor olacağız.
        // Dışarıya bir article ya da article listesi gönderirken bir ArticleDto veya ArticleListDto göndericez.
        ...
        Task<IDataResult<ArticleListDto>> GetAllByNonDeletedAndActiveAsync();   // Hem silinmemiş hem de aktif olan makaleleri getirmek istiyoruz.
        Task<IDataResult<ArticleListDto>> GetAllByCategoryAsync(int categoryId);  // Kategoriye göre makaleleri getirmek istediğimizde.
