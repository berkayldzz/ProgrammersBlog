...
namespace ProgrammersBlog.Services.Concrete
{
    public class CommentManager : ManagerBase, ICommentService
    {
        ...
        {
            // Yorum yapılacak makale üzerinde yorum sayısını da değiştirmemiz gerekiyor.(yorum eklenince veya silinince yorum sayısı değişir)
            // Yorum yapılacak gerekli makaleyi getiriyoruz.
        ...
        public async Task<IDataResult<CommentDto>> UpdateAsync(CommentUpdateDto commentUpdateDto, string modifiedByName)
        {
            ...
            updatedComment.Article = await UnitOfWork.Articles.GetAsync(a => a.Id == updatedComment.ArticleId); // Yorum güncelledikten sonra geriye döndüğümüzde article alanının boş gelmemesini istiyoruz.
            await UnitOfWork.SaveAsync();
